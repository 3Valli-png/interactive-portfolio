...
- Project Management: esperienza nella gestione di progetti trasformativi interfunzionali`
  ...
  content: `Attualmente (da maggio 2025) lavoro come OBR Plan & Forecast Senior Analyst presso Costa Crociere a Genova, una delle principali compagnie crocieristiche europee.
...
3. Dividilo!: un'app mobile-first per gestire le finanze di coppia. Permette di tracciare spese condivise (con calcolo automatico di chi deve quanto a chi) e spese personali, impostare budget mensili per categoria e monitorare l'andamento con analytics e grafici interattivi. Supporta gruppi con codice invito. Stack: Angular 21, Firebase Auth + Firestore real-time, Tailwind CSS, PWA.
...
E un progetto che combina la mia passione per il volontariato con le competenze tecniche.`
  ...
  {
    id: 'project-expense',
    title: 'Progetto Dividilo!',
    category: 'projects',
    keywords: [
      'expense', 'spese', 'tracker', 'split', 'dividere', 'soldi', 'dividilo',
      'money', 'app', 'mobile', 'firebase', 'angular', 'coppia', 'budget',
      'saldi', 'condivise', 'personali', 'tailwind'
    ],
    content: `Dividilo! e un'app mobile-first per gestire le finanze di coppia.
...
L'app permette di tracciare sia spese condivise (con calcolo automatico di chi deve quanto a chi) sia spese personali, impostare budget mensili per categoria e monitorare l'andamento con analytics e grafici interattivi (pie chart, trend mensili, KPI). Supporta gruppi con codice invito.
Lo stack e Angular 21 (standalone components, signals, zoneless change detection), Firebase Auth + Firestore real-time, Tailwind CSS, PWA con service worker. Deploy su Firebase Hosting.
E un progetto che dimostra come un'esigenza quotidiana possa diventare un esercizio tecnico completo con tecnologie moderne.`
  },
  {
    id: 'project-catasto',
